<?php
namespace TrainingJaymin\AffectedProducts\Block\Adminhtml\Contact\Edit\Tab;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    public function __construct(
        ...
        \TrainingJaymin\AffectedProducts\Helper\Data $helper,
        array $data = []
    ) {
        $this->helper = $helper;
    ...
    {
        /* @var $model \TrainingJaymin\AffectedProducts\Model\Contact */
